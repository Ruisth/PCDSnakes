 ...
 *
 */
public class ClientBoardComponent extends JComponent implements KeyListener{
    private Board board;
    private Image obstacleImage;

    public ClientBoardComponent(Board board) {
        this.board = board;
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int x = 0; x < RemoteBoard.NUM_COLUMNS; x++) {
            for (int y = 0; y < RemoteBoard.NUM_ROWS; y++) {
        ...
        for (int y = 1; y < RemoteBoard.NUM_ROWS; y++) {
            g.drawLine(0, (int)Math.round(y * CELL_WIDTH), (int)Math.round(RemoteBoard.NUM_COLUMNS*CELL_WIDTH),
    ...
    public void setBoard(Board board){
        this.board.setObstacles(board.getObstacles());
        this.board.setGoalPosition(board.getGoalPosition());
        this.board.setSnakes(board.getSnakes());
